...
namespace vansystem
{
    public partial class Herbfull : System.Web.UI.Page
    {
        ...
        private void BindGrid(int pageIndex)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_herbfull"))
                {
        ...
        protected void GVHerb_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("sp_herbfull", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string TrimTo(object stringToTrim, int noOfChar)
        {
            ...
            {
                string str = stringToTrim.ToString();
