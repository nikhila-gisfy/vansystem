<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Tree.aspx.cs" Inherits="vansystem.Tree" %>
            ...
            <div class="card" style="height: 826px; background-color: #EFEFEF">
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        <h3><b>Plot Enumeration-Tree</b></h3>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVTree" runat="server" HeaderStyle-Width="10%" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowCancelingEdit="GVTree_RowCancelingEdit" OnRowEditing="GVTree_RowEditing" OnRowUpdating="GVTree_RowUpdating" Style="width: auto" OnRowDataBound="GVTree_RowDataBound">
                                    <Columns>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="PlotEnumerationId" HeaderStyle-Width="10%" HeaderText="Survey ID" ReadOnly="true" >
