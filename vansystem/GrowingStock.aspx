<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="GrowingStock.aspx.cs" Inherits="vansystem.GrowingStock" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <head>
        <title>Van - GrowingStock</title>
        <style>
            table {
                ...
                <div class="container mt-3">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div style="margin-left: 1396px; margin-top: -27px;">
                                PageSize:
                            ...
                            <div class="box-content">
                                <asp:GridView ID="gvVLI" runat="server" AutoGenerateColumns="false" OnRowCommand="gvVLI_RowCommand" GridLines="Horizontal">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Growing Stock" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblGrowingStock" runat="server" Text='<%# Eval("GrowingStock") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
