<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="DeadWood.aspx.cs" Inherits="vansystem.DeadWood" %>
                    ...
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVDeadWood" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVDeadWood_RowEditing" OnRowUpdating="GVDeadWood_RowUpdating" OnRowCancelingEdit="GVDeadWood_RowCancelingEdit" Style="width: 1520px">
                                    <Columns>
