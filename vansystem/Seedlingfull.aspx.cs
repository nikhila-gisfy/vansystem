...
namespace vansystem
{
    public partial class Seedlingfull : System.Web.UI.Page
    {
        ...
        private void BindGrid(int pageIndex)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_seedlingfull"))
                {
        ...
        protected void GVSeedling_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                using (SqlCommand cmd = new SqlCommand("sp_seedlingfull", con))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
