...
namespace vansystem
{
    public partial class StemCount : System.Web.UI.Page
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_stemcount"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("StemCount.rdlc");
                            ReportDataSource RDstblnames = new ReportDataSource("stemcount", dt);
                            ReportViewer1.LocalReport.DataSources.Clear();
                            ReportViewer1.LocalReport.DataSources.Add(RDstblnames);
                            ReportViewer1.LocalReport.ReportPath = "StemCount.rdlc";
