<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Soil.aspx.cs" Inherits="vansystem.Soil" %>
            ...
            <div class="card" style="height: 826px; background-color: #EFEFEF">
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        <h3><b>Plot Enumeration-Soil</b></h3>
                        <div style="margin-left: 450px">
                            ...
                            <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="Soil1" Style="margin-top: -79px;" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Soil_Command" Text="Soil"> </asp:LinkButton>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVSoil" runat="server" AutoGenerateColumns="false" DataKeyNames="id" Style="width: 1520px" OnRowEditing="GVSoil_RowEditing" OnRowUpdating="GVSoil_RowUpdating" OnRowCancelingEdit="GVSoil_RowCancelingEdit">
                                    <Columns>
