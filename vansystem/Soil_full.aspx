                    ...
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVSoil" runat="server" AutoGenerateColumns="false" DataKeyNames="id" Style="width: 1520px" OnRowEditing="GVSoil_RowEditing" OnRowUpdating="GVSoil_RowUpdating" OnRowCancelingEdit="GVSoil_RowCancelingEdit" OnRowDataBound="GVSoil_RowDataBound">
                                    <Columns>
