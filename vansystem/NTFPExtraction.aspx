            ...
            <div class="app-content">
                <div class="row">
                            ...
                            <div class="scrollbar tile-body" style="max-height: 100%; overflow-y: auto;">
                                <div class="col-md-9 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtYear" runat="server" CssClass="form-control" placeholder="Reporting Year" ValidationGroup="LoginFrame"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Name of The Major NTFP/Spp." ValidationGroup="LoginFrame"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtActualcollection" runat="server" CssClass="form-control" placeholder="Difference in The Target and Actual Collection" ValidationGroup="LoginFrame"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtproductivity" runat="server" CssClass="form-control" placeholder="Measures Taken Maintaining The Productivity" ValidationGroup="LoginFrame"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtBudget" runat="server" CssClass="form-control" placeholder="Budget Allocation for NTFP Management" ValidationGroup="LoginFrame"></asp:TextBox>
                    ...
                    <div class="col-md-8 col-sm-12">
                       <div class="tile">
                            <h3 class="tile-title">NTFP Extraction Records</h3>
