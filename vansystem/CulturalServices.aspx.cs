...
namespace vansystem
{
    public partial class CulturalServices : System.Web.UI.Page
    {
        ...
        private void BindGrid(int pageIndex)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_CulturalServices"))
                {
        ...
        private void ExportGridToExcel()
        {
            ...
            GVCultural.RenderControl(HtmlTextWriter);
