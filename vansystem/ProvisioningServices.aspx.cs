...
namespace vansystem
{
    public partial class ProvisioningServices : System.Web.UI.Page
    {
        ...
        private void BindGrid(int pageIndex)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_ProvisioningServices"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        {
                            sda.Fill(dt);
                            GVProservices.DataSource = dt;
                            GVProservices.DataBind();
                        }
        ...
        private void ExportGridToExcel()
        {
            ...
            GVProservices.RenderControl(HtmlTextWriter);
