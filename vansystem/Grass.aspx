<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Grass.aspx.cs" Inherits="vansystem.Grass" %>
                ...
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div style="margin-left: 450px">
                            ...
                            <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="Grass1" Style="margin-top: -79px;" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Grass_Command" Text="Grass"> </asp:LinkButton>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVGrass" runat="server" DataKeyNames="id" ShowHeaderWhenEmpty="true" OnRowEditing="GVGrass_RowEditing" OnRowUpdating="GVGrass_RowUpdating" OnRowCancelingEdit="GVGrass_RowCancelingEdit" OnRowDataBound="GVGrass_RowDataBound" AutoGenerateColumns="false" Style="width: 1520px">
                                    <Columns>
                                      ...
                                      <%--  <asp:BoundField ItemStyle-Width="150px" DataField="grassdatadirection" HeaderText="Select corner plot">
                                       ...
                                       <asp:TemplateField HeaderText="Select corner plot">
                                        ...
                                        <asp:BoundField ItemStyle-Width="150px" DataField="grassnum" HeaderText="Specify other">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
