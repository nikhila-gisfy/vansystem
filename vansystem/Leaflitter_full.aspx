<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Leaflitter_full.aspx.cs" Inherits="vansystem.Leaflitter_full" %>
                    ...
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVLeaflitter_RowEditing" OnRowUpdating="GVLeaflitter_RowUpdating" OnRowCancelingEdit="GVLeaflitter_RowCancelingEdit" OnRowDataBound="GVLeaflitter_RowDataBound" Style="width: 1520px">
                                    <Columns>
