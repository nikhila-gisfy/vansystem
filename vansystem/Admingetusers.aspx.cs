...
namespace vansystem
{
    public partial class Admingetusers : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_admingetusers"))
                {
        ...
        protected void GVgetuser_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            Session["uid"] = uid;
            Response.Redirect("Admingetupdateuser.aspx?uid=" + uid);
