<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Seedling.aspx.cs" Inherits="vansystem.Seedling" %>
            ...
            <div class="card" style="height: 826px; background-color: #EFEFEF">
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        <h3><b>Plot Enumeration-Seedling</b></h3>
                        <div style="margin-left: 450px">
                            ...
                            <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="Seedling1" Style="margin-top: -79px;" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Seedling_Command" Text="Seedling"> </asp:LinkButton>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVSeedling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVSeedling_RowEditing" OnRowUpdating="GVSeedling_RowUpdating" OnRowCancelingEdit="GVSeedling_RowCancelingEdit" OnRowDataBound="GVSeedling_RowDataBound" Style="width: 1520px;">
                                    <Columns>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="PlotEnumerationId" HeaderText="Surveyor ID" ReadOnly="true">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
                                        <%--<asp:BoundField ItemStyle-Width="150px" DataField="seedlingdatadirection" HeaderText="Select corner plot">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>--%>
                                        <asp:TemplateField HeaderText="Select corner plot">
                                            <ItemTemplate>
                                                <asp:Label ID="lblseedlingdatadirection" runat="server" Text='<%# Eval("direction_names")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="ddlseedlingdatadirection" runat="server">
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField ItemStyle-Width="150px" DataField="seedlingnum" HeaderText="Specify other">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>


                                        <asp:BoundField ItemStyle-Width="150px" DataField="totalnos" HeaderText="Average number">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
