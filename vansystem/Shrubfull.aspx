<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Shrubfull.aspx.cs" Inherits="vansystem.Shrubfull" %>
            ...
            <div class="card" style="height: 826px; background-color: #EFEFEF">
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        <h3><b>Plot Enumeration-Shurb</b></h3>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVShurb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" OnRowEditing="GVShurb_RowEditing" OnRowUpdating="GVShurb_RowUpdating" OnRowCancelingEdit="GVShurb_RowCancelingEdit" OnRowDataBound="GVShurb_RowDataBound" DataKeyNames="id" Style="width: auto">
                                    <Columns>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="PlotEnumerationId" HeaderText="Surveyor ID" ReadOnly="true">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
                                    <%--    <asp:BoundField ItemStyle-Width="150px" DataField="shrubdatadirection" HeaderText="Select corner plot">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>--%>

                                         <asp:TemplateField HeaderText="Select corner plot">
                                            <ItemTemplate>
                                                <asp:Label ID="lblshrubdatadirection" runat="server" Text='<%# Eval("direction_names")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="ddlshrubdatadirection" runat="server">
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField ItemStyle-Width="150px" DataField="shrubnum" HeaderText="Specify other">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="girth" HeaderText="Collar girth at base">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
