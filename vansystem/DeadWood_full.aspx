<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="DeadWood_full.aspx.cs" Inherits="vansystem.DeadWood_full" %>
            ...
            <div class="card" style="height: 826px; background-color: #EFEFEF">
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        <h3><b>Plot Enumeration-DeadWood</b></h3>
                        <div style="margin-left: 450px">
                            ...
                            <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="DeadWood1" Style="margin-top: -79px;" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="DeadWood_Command" Text="Dead Wood"> </asp:LinkButton>
                        </div>
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVDeadWood" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVDeadWood_RowEditing" OnRowUpdating="GVDeadWood_RowUpdating" OnRowCancelingEdit="GVDeadWood_RowCancelingEdit" OnRowDataBound="GVDeadWood_RowDataBound" Style="width: 1520px">
                                    <Columns>
                                       ...
                                       <%-- <asp:BoundField ItemStyle-Width="150px" DataField="direction" HeaderText="Select corner plot">
                                        ...
                                        <asp:BoundField ItemStyle-Width="150px" DataField="dead_wood_weight_in_grams" HeaderText="Dead wood weight (in Grms)">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="sub_sample_weight" HeaderText="Sample weight">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField ItemStyle-Width="150px" DataField="sample_plot_number" HeaderText="Sample Number">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>
