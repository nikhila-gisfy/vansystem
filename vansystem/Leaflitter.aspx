<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Leaflitter.aspx.cs" Inherits="vansystem.Leaflitter" %>
                    ...
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); width: 1584px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVLeaflitter_RowEditing" OnRowUpdating="GVLeaflitter_RowUpdating" OnRowCancelingEdit="GVLeaflitter_RowCancelingEdit" Style="width: 1520px">
                                    <Columns>
