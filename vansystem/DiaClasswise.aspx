<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="DiaClasswise.aspx.cs" Inherits="vansystem.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin-left: 50px;">
            <div class="card-header">
                <h3 class="card-title">DIA_CLASSWISE REPORT</h3>
