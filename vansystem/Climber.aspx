<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Climber.aspx.cs" Inherits="vansystem.Climber" %>
                ...
                <div class="container mt-6">
                    <div style="margin-left: -19%; width: 113%; margin-top: 88px;">
                        ...
                        <div style="margin-left: 450px">
                            ...
                            <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="Climber1" Style="margin-top: -79px;" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Climber_Command" Text="Climber"> </asp:LinkButton>
