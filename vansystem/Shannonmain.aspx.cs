...
namespace vansystem
{
    public partial class Shannonmain : System.Web.UI.Page
    {
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("sp_shannon"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            ReportParameter rp2 = new ReportParameter("heading", "Shannon Diversity Index (\"H\")");
                ...
                using (SqlCommand cmd = new SqlCommand("sp_shannon"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            ReportParameter rp3 = new ReportParameter("heading", "Shannon Diversity Index (\"H\")");
                            ReportParameter rp4 = new ReportParameter("level", "Range-Wise");
                            //ReportParameter rp4 = new ReportParameter("minheading", "Min_Shannon Value");
                            //ReportParameter rp5 = new ReportParameter("maxheading", "Max_Shannon Value");
                            //ReportParameter rp6 = new ReportParameter("avgheading", "Average_Shannon Value");
                            //ReportParameter rp7 = new ReportParameter("SDheading", "SD_Shannon Value");
                            ...
                            ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { rp1,  rp3 ,rp4});
                            ReportViewer1.LocalReport.Refresh();
                        }
                    }
                }
                ...
                using (SqlCommand cmd = new SqlCommand("sp_shannon"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            //ReportParameter rp2 = new ReportParameter("login", "adilabad-DFO");
                            ReportParameter rp3 = new ReportParameter("heading", "Shannon Diversity Index (\"H\")");
                            ReportParameter rp4 = new ReportParameter("level", "Block-Wise");
                            //ReportParameter rp5 = new ReportParameter("maxheading", "Max_Shannon Value");
                            //ReportParameter rp6 = new ReportParameter("avgheading", "Average_Shannon Value");
                            //ReportParameter rp7 = new ReportParameter("SDheading", "SD_Shannon Value");
                ...
                using (SqlCommand cmd = new SqlCommand("sp_shannon"))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        ...
                        using (DataTable dt = new DataTable())
                        {
                            ...
                            //ReportParameter rp2 = new ReportParameter("login", "adilabad-DFO");
                            ReportParameter rp3 = new ReportParameter("heading", "Shannon Diversity Index (\"H\")");
                            ReportParameter rp4 = new ReportParameter("level", "Compartment-Wise");
                            //ReportParameter rp5 = new ReportParameter("maxheading", "Max_Shannon Value");
                            //ReportParameter rp6 = new ReportParameter("avgheading", "Average_Shannon Value");
                            //ReportParameter rp7 = new ReportParameter("SDheading", "SD_Shannon Value");
